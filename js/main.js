...
var map = function () {
  var myLatlng = new google.maps.LatLng(37.780171, -122.417563),
    ...
    mapTypeId: google.maps.MapTypeId.ROADMAP
      ...
      contentString = '<div id="content">' + '<div id="siteNotice">' + '</div>' + '<div id="bodyContent"' + '<p class="map-text">PO Box 7775</p>' + '<p class="map-text">San francisco, CA</p>' + '<p class="map-text">94120-7775, US</p>' + '<p class="map-text">Tel. +1 951-693-1880</p>' + '</div>' + '</div>',
